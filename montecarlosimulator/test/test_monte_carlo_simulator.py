...
class TestDispersions:
    ...
    def test_generate_dispersions_from_nested_dataclass(self):
        ...
        for _, (dispersed_args, dispersed_kwargs) in zip(range(50), dispersion_generator):
            ...
            # 'This fails because of the wrapping NestedSimulationData has '
            # 'changed type, but otherwise it would be correct'
...
class TestSimulations:
    ...
    def test_results_of_failed_sim(self):
        ...
        # This test has technically aleatory results, but with n_simulations = 100,
        # the probability of an erroneous result is 1/2^100.
    ...
    def test_complex_simulation_parallel(self, mcs_complex, mcs_complex_datadict):
        """
        ...
        results = mcs_complex.compute(**mcs_complex_datadict)
